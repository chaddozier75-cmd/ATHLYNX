-- Fellowship of Christian Athletes (FCA) Tables

CREATE TABLE IF NOT EXISTS `fca_devotionals` (
...
CREATE TABLE IF NOT EXISTS `fca_podcasts` (
  `id` int AUTO_INCREMENT NOT NULL,
  `title` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `fca_blog_posts` (
  `id` int AUTO_INCREMENT NOT NULL,
  `title` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `fca_prayer_requests` (
  `id` int AUTO_INCREMENT NOT NULL,
  `userId` int NOT NULL,
  ...
  CONSTRAINT `fca_prayer_requests_userId_users_id_fk` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
);

CREATE TABLE IF NOT EXISTS `fca_testimonies` (
  `id` int AUTO_INCREMENT NOT NULL,
  `userId` int NOT NULL,
  ...
  CONSTRAINT `fca_testimonies_userId_users_id_fk` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
);

CREATE TABLE IF NOT EXISTS `fca_comments` (
  `id` int AUTO_INCREMENT NOT NULL,
  `userId` int NOT NULL,
  `userName` varchar(255) NOT NULL,
  ...
  CONSTRAINT `fca_comments_userId_users_id_fk` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
);

CREATE TABLE IF NOT EXISTS `fca_daily_verses` (
  `id` int AUTO_INCREMENT NOT NULL,
  `verse` text NOT NULL,
  `reference` varchar(100) NOT NULL,
  `translation` varchar(50) NOT NULL DEFAULT 'NIV',
  `displayDate` date NOT NULL UNIQUE,
  `views` int NOT NULL DEFAULT 0,
  `shares` int NOT NULL DEFAULT 0,
  `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
